...
#
#######################
print "<center><h1>Übersicht Datahub</h1></center>";
foreach ($dh_db->query(" select sensor_id, sensor_name from sensor ") as $row_sensor) {
    ...
    print "<ul class='ui-listview ui-listview-inset ui-corner-all ui-shadow' data-inset='true' data-role='listview'>".
          ...
          "<li><a id='xxxhead".$mysensorid."' class='ui-btn ui-btn-icon-right ui-icon-carat-r ui-shadow' data-theme='a' href='#' onclick=show_detail($mysensorid,1); ".
          " data-rel='popup' style='background: #666666; color: black; ' ><center>".$mysensorname."(".$mysensorid.")</center></a></li>".
          "<li class='ui-li-divider ui-bar-inherit ui-last-child' data-role='list-divider' role='heading' style='background:".$bgcolor."; color: white;'></li>".
          "</ul>\n";
}
