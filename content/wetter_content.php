...
<?php
  $results = $db_sh->query("SELECT value FROM sensor_im where sensor_id = ".$wetter_temp_sensor." LIMIT 1");
...
<?php
  $results = $db_sh->query("SELECT value FROM sensor_im where sensor_id = ".$wetter_pres_sensor." LIMIT 1");
  $row = $results->fetch_assoc();
...
<?php
  $results = $db_sh->query("SELECT value FROM sensor_im where sensor_id = ".$wetter_humi_sensor." LIMIT 1");
  $row = $results->fetch_assoc();
  echo number_format($row['value'],1, ",", ".");
?>
 &#37;</div></center></div>
